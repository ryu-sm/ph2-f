...
export const ApStep05Page = () => {
  ...
  const parseVaildData = useMemo(() => {
    return {
      p_applicant_persons__1__office_occupation: formik.values.p_applicant_persons__1__office_occupation,
      p_applicant_persons__1__office_occupation_other: formik.values.p_applicant_persons__1__office_occupation_other,
      p_applicant_persons__1__office_industry: formik.values.p_applicant_persons__1__office_industry,
      p_applicant_persons__1__office_industry_other: formik.values.p_applicant_persons__1__office_industry_other,
      p_applicant_persons__1__office_occupation_detail: formik.values.p_applicant_persons__1__office_occupation_detail,
      p_applicant_persons__1__office_occupation_detail_other:
        formik.values.p_applicant_persons__1__office_occupation_detail_other,
      p_applicant_persons__1__office_name_kanji: formik.values.p_applicant_persons__1__office_name_kanji,
      p_applicant_persons__1__office_department: formik.values.p_applicant_persons__1__office_department,
      p_applicant_persons__1__office_phone: formik.values.p_applicant_persons__1__office_phone,
      p_applicant_persons__1__office_postal_code: formik.values.p_applicant_persons__1__office_postal_code,
      p_applicant_persons__1__office_prefecture_kanji: formik.values.p_applicant_persons__1__office_prefecture_kanji,
      p_applicant_persons__1__office_city_kanji: formik.values.p_applicant_persons__1__office_city_kanji,
      p_applicant_persons__1__office_district_kanji: formik.values.p_applicant_persons__1__office_district_kanji,
      p_applicant_persons__1__office_other_address_kanji:
        formik.values.p_applicant_persons__1__office_other_address_kanji,
      p_applicant_persons__1__office_employee_num: formik.values.p_applicant_persons__1__office_employee_num,
      p_applicant_persons__1__office_joining_date: formik.values.p_applicant_persons__1__office_joining_date,
      p_applicant_persons__1__last_year_income: formik.values.p_applicant_persons__1__last_year_income,
      p_applicant_persons__1__last_year_bonus_income: formik.values.p_applicant_persons__1__last_year_bonus_income,
      p_applicant_persons__1__income_sources: formik.values.p_applicant_persons__1__income_sources,
      p_applicant_persons__1__tax_return: formik.values.p_applicant_persons__1__tax_return,
      p_applicant_persons__1__tax_return_reasons: formik.values.p_applicant_persons__1__tax_return_reasons,
      p_applicant_persons__1__tax_return_reason_other: formik.values.p_applicant_persons__1__tax_return_reason_other,
      p_applicant_persons__1__transfer_office: formik.values.p_applicant_persons__1__transfer_office,
      p_applicant_persons__1__transfer_office_name_kanji:
        formik.values.p_applicant_persons__1__transfer_office_name_kanji,
      p_applicant_persons__1__transfer_office_name_kana:
        formik.values.p_applicant_persons__1__transfer_office_name_kana,
      p_applicant_persons__1__transfer_office_phone: formik.values.p_applicant_persons__1__transfer_office_phone,
      p_applicant_persons__1__transfer_office_postal_code:
        formik.values.p_applicant_persons__1__transfer_office_postal_code,
      p_applicant_persons__1__transfer_office_prefecture_kanji:
        formik.values.p_applicant_persons__1__transfer_office_prefecture_kanji,
      p_applicant_persons__1__transfer_office_city_kanji:
        formik.values.p_applicant_persons__1__transfer_office_city_kanji,
      p_applicant_persons__1__transfer_office_district_kanji:
        formik.values.p_applicant_persons__1__transfer_office_district_kanji,
      p_applicant_persons__1__transfer_office_other_address_kanji:
        formik.values.p_applicant_persons__1__transfer_office_other_address_kanji,
      p_applicant_persons__1__maternity_paternity_leave:
        formik.values.p_applicant_persons__1__maternity_paternity_leave,
      p_applicant_persons__1__maternity_paternity_leave_start_date:
        formik.values.p_applicant_persons__1__maternity_paternity_leave_start_date,
      p_applicant_persons__1__maternity_paternity_leave_end_date:
        formik.values.p_applicant_persons__1__maternity_paternity_leave_end_date,
      p_applicant_persons__1__nursing_leave: formik.values.p_applicant_persons__1__nursing_leave,
    };
  }, [formik.values]);
  const handelLeft = () => {
    ...
    <FormikProvider value={formik}>
      ...
      <ApLayout hasMenu hasStepBar pb={18}>
        ...
        <ApItemGroup label={'ご職業'}>
          <Stack spacing={3}>
            <ApSelectField
              name="p_applicant_persons__1__office_occupation"
            ...
            {formik.values.p_applicant_persons__1__office_occupation === '99' && (
              <Stack spacing={'6px'}>
                ...
                <ApTextInputField
                  name="p_applicant_persons__1__office_occupation_other"
        ...
        <ApItemGroup label={'業種'}>
          <Stack spacing={3}>
            <ApSelectField
              name="p_applicant_persons__1__office_industry"
              placeholder={'選択してください'}
              width={1}
              justifyContent={'start'}
            ...
            {formik.values.p_applicant_persons__1__office_industry === '99' && (
              <Stack spacing={'6px'}>
                ...
                <ApTextInputField
                  name="p_applicant_persons__1__office_industry_other"
                  placeholder={'入力してください'}
                  convertFullWidth
                />
              </Stack>
        ...
        <ApItemGroup label={'職種'}>
          <Stack spacing={3}>
            <ApSelectField
              name="p_applicant_persons__1__office_occupation_detail"
              placeholder={'選択してください'}
              width={1}
              justifyContent={'start'}
            ...
            {formik.values.p_applicant_persons__1__office_occupation_detail === '99' && (
              <Stack spacing={'6px'}>
                ...
                <ApTextInputField
                  name="p_applicant_persons__1__office_occupation_detail_other"
                  placeholder={'入力してください'}
                  convertFullWidth
                />
              </Stack>
        ...
        <ApItemGroup label={'勤務先名'}>
          <ApTextInputField
            name="p_applicant_persons__1__office_name_kanji"
            placeholder={'例：株式会社○○○○○'}
            convertFullWidth
          />
        </ApItemGroup>
        <ApItemGroup label={'所属部課'}>
          <Stack spacing={'6px'}>
            <ApTextInputField
              name="p_applicant_persons__1__office_department"
              placeholder={'例：○○部'}
              convertFullWidth
            />
        ...
        <ApItemGroup label={'勤務先の電話番号'}>
          <Stack spacing={'6px'}>
            <ApPhoneInputField name="p_applicant_persons__1__office_phone" />
            <Stack spacing={'6px'}>
        ...
        <ApItemGroup label={'勤務先の住所'} note={'※実際に勤務している事業所の住所をご入力ください'}>
          <Stack spacing={4}>
            ...
            />
            <ApTextInputField
              name="p_applicant_persons__1__office_city_kanji"
              placeholder={'例：港区'}
              label={'市区郡　（例：港区）'}
              convertFullWidth
            />
            <ApTextInputField
              name="p_applicant_persons__1__office_district_kanji"
              placeholder={'例：芝浦４丁目'}
              label={'町村丁目（例：芝浦４丁目）'}
              convertFullWidth
            />
            <ApTextInputField
              name="p_applicant_persons__1__office_other_address_kanji"
        ...
        <ApItemGroup label={'従業員数'}>
          <ApNumberInputField
            name="p_applicant_persons__1__office_employee_num"
            unit={'名'}
            placeholder={'0'}
            width={156}
            maxLength={9}
        ...
        <ApItemGroup label={'入社年月'}>
          <ApSelectFieldYm name="p_applicant_persons__1__office_joining_date" yearOptions={officeJoiningDateOptions} />
        </ApItemGroup>
          ...
          >
            ...
            >
              <ApItemGroup label={'前年度年収'} pb={3} px={2} borderTopRightRadius={'7px'} borderTopLeftRadius={'7px'}>
                <Stack spacing={3}>
                  <ApNumberInputField
                    name="p_applicant_persons__1__last_year_income"
                    placeholder={'0'}
                    unit={'万円'}
                    width={156}
                    maxLength={6}
                  ...
                  {isMCJ && (
                    <ApNumberInputField
                      name="p_applicant_persons__1__last_year_bonus_income"
                      label={
              ...
              >
                <ApCheckboxButtonGroup name="p_applicant_persons__1__income_sources" options={incomeOptions} />
              </ApItemGroup>

              <ApItemGroup label={'確定申告をしていますか？'}>
                <ApRadioRowGroup
                  name="p_applicant_persons__1__tax_return"
                  options={taxReturnOptions}
                  onChange={(e) => {
                    if (e.target.value === '0') {
                      formik.setFieldValue('p_applicant_persons__1__tax_return_reasons', []);
                      formik.setFieldValue('p_applicant_persons__1__tax_return_reason_other', '');
                      formik.setFieldTouched('p_applicant_persons__1__tax_return_reasons', false);
                      formik.setFieldTouched('p_applicant_persons__1__tax_return_reason_other', false);
                    }
                  }}
                />
              </ApItemGroup>
              {formik.values.p_applicant_persons__1__tax_return === '1' && (
                <ApItemGroup
                  label={
                    <Stack spacing={1} direction={'row'} alignItems={'flex-end'}>
                      <Typography variant="form_item_label" color={'text.main'}>
                  ...
                  <Stack spacing={3}>
                    ...
                    {formik.values.p_applicant_persons__1__tax_return_reasons.includes('99') && (
                      <Stack spacing={'6px'}>
                        ...
                        <ApTextInputField
                          name="p_applicant_persons__1__tax_return_reason_other"
                          placeholder={'入力してください'}
                          convertFullWidth
                        />
                      </Stack>
        ...
        <ApItemGroup label={'現在、出向（派遣）していますか？'}>
          <Stack spacing={3}>
            <ApRadioRowGroup
              name="p_applicant_persons__1__transfer_office"
              options={transferOfficeOptions}
              onChange={(e) => {
                if (e.target.value === '0') {
                  formik.setFieldValue('p_applicant_persons__1__transfer_office_name_kanji', '');
                  formik.setFieldValue('p_applicant_persons__1__transfer_office_name_kana', '');
                  formik.setFieldValue('p_applicant_persons__1__transfer_office_phone', '');

                  formik.setFieldTouched('p_applicant_persons__1__transfer_office_name_kanji', false);
                  formik.setFieldTouched('p_applicant_persons__1__transfer_office_name_kana', false);
                  formik.setFieldTouched('p_applicant_persons__1__transfer_office_phone', false);
                }
              }}
            />
            {formik.values.p_applicant_persons__1__transfer_office === '1' && (
              <Stack
                sx={{
                  mt: 3,
                  borderRadius: 2,
              ...
              >
                ...
                >
                  <ApItemGroup label={'出向（派遣）勤務先名'} pb={3} px={2}>
                    <ApTextInputField
                      name="p_applicant_persons__1__transfer_office_name_kanji"
                      placeholder={'例：株式会社○○○○○'}
                      convertFullWidth
                    />
                  </ApItemGroup>
                  <ApItemGroup label={'出向（派遣）勤務先名（フリガナ）'} pb={3} px={2}>
                    <ApTextInputField
                      name="p_applicant_persons__1__transfer_office_name_kana"
                  ...
                  <ApItemGroup label={'出向（派遣）先　電話番号'}>
                    <Stack spacing={'6px'}>
                      <ApPhoneInputField name="p_applicant_persons__1__transfer_office_phone" />
                      <ApStarHelp label={'半角数字でご入力ください。'} />
                    </Stack>
                  </ApItemGroup>
                  <ApItemGroup label={'出向（派遣）先　住所'}>
                    <Stack spacing={4}>
                      ...
                      />
                      <ApTextInputField
                        name="p_applicant_persons__1__transfer_office_city_kanji"
                        placeholder={'例：港区'}
                        label={'市区郡　（例：港区）'}
                        convertFullWidth
                      />
                      <ApTextInputField
                        name="p_applicant_persons__1__transfer_office_district_kanji"
                        placeholder={'例：芝浦４丁目'}
                        label={'町村丁目（例：芝浦４丁目）'}
                        convertFullWidth
                      />
                      <ApTextInputField
                        name="p_applicant_persons__1__transfer_office_other_address_kanji"
                        placeholder={'例：12-38　キャナルゲート芝浦605号室'}
                        label={'丁目以下・建物名・部屋番号（例：12-38　キャナルゲート芝浦605号室）'}
                        convertFullWidth
                      />
        ...
        <ApItemGroup optional label={'産休・育休の取得状況'} note={'※該当する方のみお答えください。'}>
          <Stack spacing={3}>
            <ApRadioColumnGroup
              name="p_applicant_persons__1__maternity_paternity_leave"
        ...
        {isMCJ && (
          <ApItemGroup
            ...
            note={'※該当する方のみお答えください。'}
          >
            <ApRadioColumnGroup name="p_applicant_persons__1__nursing_leave" cancelable options={nursingLeaveOptions} />
          </ApItemGroup>
        )}
