  ...
  return (
    <ApConfirmGroup stepIndex={stepIndex} label={`：収入合算者の書類`}>
            ...
            <Stack spacing={3}>
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.A__01__a.length ? (
                  <ApImgItem files={p_applicant_persons__1?.A__01__a} />
                ) : (
              ...
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.A__01__b.length ? (
                  <ApImgItem files={p_applicant_persons__1?.A__01__b} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
          ...
          <Stack spacing={3}>
            ...
            <Stack spacing={'6px'}>
              ...
              {p_applicant_persons__1?.A__02.length ? (
                <ApImgItem files={p_applicant_persons__1?.A__02} />
              ) : (
                <Typography variant="label" color={'gray.150'}>
                  〈 書類はまだ添付されません。〉
                </Typography>
            ...
            <Stack spacing={3}>
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.A__03__a.length ? (
                  <ApImgItem files={p_applicant_persons__1?.A__03__a} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
              ...
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.A__03__b.length ? (
                  <ApImgItem files={p_applicant_persons__1?.A__03__b} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
      ...
      <ApConfirmItemGroup label={'健康保険証'}>
        <Stack spacing={3}>
          <Stack spacing={'6px'}>
            ...
            {p_applicant_persons__1?.B__a.length ? (
              <ApImgItem files={p_applicant_persons__1?.B__a} />
            ) : (
              <Typography variant="label" color={'gray.150'}>
                〈 書類はまだ添付されません。〉
              </Typography>
          ...
          <Stack spacing={'6px'}>
            ...
            {p_applicant_persons__1?.B__b.length ? (
              <ApImgItem files={p_applicant_persons__1?.B__b} />
            ) : (
              <Typography variant="label" color={'gray.150'}>
                〈 書類はまだ添付されません。〉
              </Typography>
            ...
            <Stack spacing={3}>
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.C__01.length ? (
                  <ApImgItem files={p_applicant_persons__1?.C__01} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
              ...
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.C__02.length ? (
                  <ApImgItem files={p_applicant_persons__1?.C__02} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
            ...
            <Stack spacing={3}>
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.D__01.length ? (
                  <ApImgItem files={p_applicant_persons__1?.D__01} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
              ...
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.D__02.length ? (
                  <ApImgItem files={p_applicant_persons__1?.D__02} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
              ...
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.D__03.length ? (
                  <ApImgItem files={p_applicant_persons__1?.D__03} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
        ...
        <Stack>
          ...
          <ApConfirmItemGroup label={'雇用契約に関する書類'}>
            <Stack spacing={'6px'}>
              ...
              {p_applicant_persons__1?.E.length ? (
                <ApImgItem files={p_applicant_persons__1?.E} />
              ) : (
                <Typography variant="label" color={'gray.150'}>
                  〈 書類はまだ添付されません。〉
                </Typography>
            ...
            <Stack spacing={3}>
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.F__01.length ? (
                  <ApImgItem files={p_applicant_persons__1?.F__01} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
              ...
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.F__02.length ? (
                  <ApImgItem files={p_applicant_persons__1?.F__02} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
              ...
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.F__03.length ? (
                  <ApImgItem files={p_applicant_persons__1?.F__03} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
            ...
            <Stack spacing={3}>
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.C__03.length ? (
                  <ApImgItem files={p_applicant_persons__1?.C__03} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
              ...
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.C__04.length ? (
                  <ApImgItem files={p_applicant_persons__1?.C__04} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
              ...
              <Stack spacing={'6px'}>
                ...
                {p_applicant_persons__1?.C__05.length ? (
                  <ApImgItem files={p_applicant_persons__1?.C__05} />
                ) : (
                  <Typography variant="label" color={'gray.150'}>
                    〈 書類はまだ添付されません。〉
                  </Typography>
      ...
      <ApConfirmItemGroup label={`その他の書類`}>
        {p_applicant_persons__1?.K.length ? (
          <ApImgItem files={p_applicant_persons__1?.K} />
        ) : (
          <Typography variant="label" color={'gray.150'}>
            〈 書類はまだ添付されません。〉
          </Typography>
