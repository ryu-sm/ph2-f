...
export const ApStep07Info = ({ stepIndex }) => {
  ...
  return (
    <ApConfirmGroup label={`STEP${stepIndex}：お住まい`}>
      <ApConfirmItemGroup label={'現在のお住まいの居住年数'}>
        <Stack spacing={1} alignItems={'start'}>
          {p_application_headers__curr_house_lived_year && p_application_headers__curr_house_lived_month && (
            ...
            <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
              {
                currHouseResidenceTypeOptions.find(
                  (item) => item.value === p_application_headers__curr_house_residence_type
                ).label
              }
            </Typography>
          ) : (
      ...
      {p_application_headers__curr_house_residence_type === '4' && (
        <Stack>
      ...
      {p_application_headers__curr_house_residence_type === '5' && (
        <Stack>
              ...
              <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                {
                  currHouseScheduleDisposalTypeOptions.find(
                    (item) => item.value === p_application_headers__curr_house_schedule_disposal_type
                  ).label
                }
              </Typography>
            ) : (
          ...
          {p_application_headers__curr_house_schedule_disposal_type === '99' && (
          ...
          {p_application_headers__curr_house_schedule_disposal_type === '1' && (
            <Stack>
              <ApConfirmItemGroup label={'売却予定時期'}>
                {p_application_headers__curr_house_shell_scheduled_date ? (
                  <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                    {formatJapanDate(p_application_headers__curr_house_shell_scheduled_date)}
                  </Typography>
                ) : (
                  'ー'
                )}
              ...
              <ApConfirmItemGroup label={'売却予定価格'}>
                {p_application_headers__curr_house_shell_scheduled_price ? (
                  <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                    {Number(p_application_headers__curr_house_shell_scheduled_price).toLocaleString()}
                  </Typography>
                ) : (
                  'ー'
                )}
              ...
              <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                {
                  currHouseLoanBalanceTypeOptions.find(
                    (item) => item.value === p_application_headers__curr_house_loan_balance_type
                  ).label
                }
              </Typography>
            ) : (
      ...
      <ApConfirmItemGroup label={'物件情報の画像添付'}>
        {p_application_headers__property_G.length ? (
          <ApImgItem files={p_application_headers__property_G} />
        ) : (
          '〈 書類はまだ添付されません。〉'
        )}
      </ApConfirmItemGroup>
      ...
      {p_application_headers__loan_target !== '7' && (
        <Stack>
              ...
              <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                {
                  newHouseAcquireReasonOptions.find(
                    (item) => item.value === p_application_headers__new_house_acquire_reason
                  ).label
                }
              </Typography>
            ) : (
          ...
          {p_application_headers__new_house_acquire_reason === '99' && (
            <ApConfirmItemGroup label={'その他の詳細'}>
              {p_application_headers__new_house_acquire_reason_other ? (
                <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                  {p_application_headers__new_house_acquire_reason_other}
          ...
          {p_application_headers__new_house_self_resident === '0' && (
      ...
      <ApConfirmItemGroup label={'あなた以外の入居予定者'}>
        {p_application_headers__new_house_planned_resident_overview.spouse_umu ||
        p_application_headers__new_house_planned_resident_overview.children_umu ||
        p_application_headers__new_house_planned_resident_overview.father_umu ||
        p_application_headers__new_house_planned_resident_overview.mother_umu ||
        p_application_headers__new_house_planned_resident_overview.brothers_sisters_umu ||
        p_application_headers__new_house_planned_resident_overview.fiance_umu ||
        p_application_headers__new_house_planned_resident_overview.others_umu ? (
          <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
            {[
              p_application_headers__new_house_planned_resident_overview.spouse && '配偶者',
              p_application_headers__new_house_planned_resident_overview.children &&
                `子ども${p_application_headers__new_house_planned_resident_overview.children}人`,
              p_application_headers__new_house_planned_resident_overview.father && '父',
              p_application_headers__new_house_planned_resident_overview.mother && '母',
              p_application_headers__new_house_planned_resident_overview.brothers_sisters &&
                `兄弟姉妹${p_application_headers__new_house_planned_resident_overview.brothers_sisters}人`,
              p_application_headers__new_house_planned_resident_overview.fiance && '婚約者',
              p_application_headers__new_house_planned_resident_overview.others &&
                `その他${p_application_headers__new_house_planned_resident_overview.others}人`,
            ]
              .filter((item) => !!item)
              .join(',')}
          </Typography>
      ...
      {p_application_headers__new_house_planned_resident_overview.others_umu &&
        p_application_headers__new_house_planned_resident_overview.others && (
          <ApConfirmItemGroup label={'その他の続柄'}>
            {p_application_headers__new_house_planned_resident_overview.others_rel ? (
              <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                {p_application_headers__new_house_planned_resident_overview.others_rel}
              </Typography>
            ) : (
      ...
      {isMCJ && p_application_headers__new_house_self_resident === '0' && (
        <Stack>
      ...
      <ApConfirmItemGroup label={'新しい住居（融資対象物件）の事業性'}>
        {p_application_headers__property_business_type.length ? (
          <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
            {p_application_headers__property_business_type
      ...
      <ApConfirmItemGroup label={'ご購入物件の所在地'}>
        ...
        p_application_headers__property_district ? (
          <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
            {`${p_application_headers__property_prefecture}${p_application_headers__property_city}${p_application_headers__property_district}`}
          </Typography>
        ) : (
          'ー'
        )}
      ...
      {isMCJ && (
        <Stack>
          <ApConfirmItemGroup label={'ご購入物件の土地権利'}>
            {p_application_headers__property_land_type ? (
              <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                {propertyLandTypeOptions.find((item) => item.value === p_application_headers__property_land_type).label}
              </Typography>
            ) : (
              'ー'
            )}
              ...
              <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                {
                  propertyPurchaseTypeOptions.find(
                    (item) => item.value === p_application_headers__property_purchase_type
                  ).label
                }
              </Typography>
            ) : (
              ...
              <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                {
                  propertyPlanningAreaOptions.find(
                    (item) => item.value === p_application_headers__property_planning_area
                  ).label
                }
              </Typography>
            ) : (
          ...
          {p_application_headers__property_planning_area === '99' && (
            <ApConfirmItemGroup label={'その他の詳細'}>
              {p_application_headers__property_planning_area_other ? (
                <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                  {p_application_headers__property_planning_area_other}
          ...
          {['1', '2'].includes(p_application_headers__property_planning_area) && (
            <ApConfirmItemGroup label={'再建築理由'}>
              {p_application_headers__property_rebuilding_reason ? (
                <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                  {
                    propertyRebuildingReasonOptions.find(
                      (item) => item.value === p_application_headers__property_rebuilding_reason
                    ).label
                  }
                </Typography>
              ) : (
          ...
          {p_application_headers__property_rebuilding_reason === '99' && (
            <ApConfirmItemGroup label={'その他の詳細'}>
              {p_application_headers__property_rebuilding_reason_other ? (
                <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
                  {p_application_headers__property_rebuilding_reason_other}
      ...
      <ApConfirmItemGroup label={'フラット35S（優良住宅取得支援制度）対象項目'}>
        {p_application_headers__property_flat_35_plan ? (
          <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
            {
              propertyFlat35PlanOptions.find((item) => item.value === p_application_headers__property_flat_35_plan)
                .label
            }
          </Typography>
        ) : (
          ...
          <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
            {
              propertyMaintenanceTypeOptions.find(
                (item) => item.value === p_application_headers__property_maintenance_type
              ).label
            }
          </Typography>
        ) : (
      ...
      {p_application_headers__property_flat_35_plan === '2' && (
        <ApConfirmItemGroup label={'フラット35S（優良住宅取得支援制度）対象項目②'}>
          {p_application_headers__property_flat_35_tech ? (
            <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
              {
                propertyFlat35TechOptions.find((item) => item.value === p_application_headers__property_flat_35_tech)
                  .label
              }
            </Typography>
          ) : (
      ...
      <ApConfirmItemGroup label={'地域連携型・地方移住支援型'}>
        {p_application_headers__property_region_type ? (
          <Typography variant="modal_label" color={'text.main'} textAlign={'start'}>
            {propertyRegionTypeOptions.find((item) => item.value === p_application_headers__property_region_type).label}
          </Typography>
        ) : (
          'ー'
        )}
