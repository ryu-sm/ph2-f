    ...
    identity_verification_type: yup
      ...
      .test(
        ...
        (
          ...
          if (field_value === '1') {
            return (
              p_uploaded_files.p_applicant_persons__0__A__01__a.length > 0 &&
              p_uploaded_files.p_applicant_persons__0__A__01__b.length
            );
          }
          if (field_value === '2') {
            return p_uploaded_files.p_applicant_persons__0__A__02.length > 0;
          }
          if (field_value === '3') {
            return (
              p_uploaded_files.p_applicant_persons__0__A__03__a.length > 0 &&
