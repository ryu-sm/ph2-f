        ...
        <ApConfirmItemGroup label={'在留カードまたは特別永住者証明書を添付してください。'}>
          <Stack spacing={3}>
            <Stack spacing={'6px'}>
              ...
              {p_applicant_persons__0.H__a.length ? (
                <ApImgItem files={p_applicant_persons__0.H__a} />
              ) : (
            ...
            <Stack spacing={'6px'}>
              ...
              {p_applicant_persons__0.H__b.length ? (
                <ApImgItem files={p_applicant_persons__0.H__b} />
              ) : (
                <Typography variant="label" color={'gray.150'}>
                  〈 書類はまだ添付されません。〉
                </Typography>
