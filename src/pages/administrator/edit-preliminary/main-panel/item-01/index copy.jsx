...
export const Item01 = () => {
  const {
    preliminaryInfo: { p_application_headers, p_application_banks, p_borrowing_details__1, p_borrowing_details__2 },
    setPreliminarySnap,
  ...
  return (
    <FormikProvider value={formik}>
      <Stack width={'100%'} height={'100%'}>
        <Stack width={'100%'} direction={'row'} justifyContent={'flex-end'} sx={{ py: 3 }}>
          <AdSaveButton onClick={formik.handleSubmit} />
        </Stack>
