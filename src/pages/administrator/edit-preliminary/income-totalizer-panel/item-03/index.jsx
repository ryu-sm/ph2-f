...
export const Item03 = () => {
  ...
  const initialValues = {
    p_applicant_persons__1: {
      ...
      before_last_year_bonus_income: p_applicant_persons__1?.before_last_year_bonus_income,
    },
  };
      ...
      <ContentEditGroup isEditable={isEditable} handleSave={() => handleSave(setUpdateData(formik.values))}>
        ...
        {formik.values.p_applicant_persons__1.office_occupation === '99' && (
          <EditRow
            ...
            field={
              isEditable ? (
                <AdEditInput name="p_applicant_persons__1.office_occupation_other" convertFullWidth />
              ) : (
        ...
        {formik.values.p_applicant_persons__1.office_industry === '99' && (
          <EditRow
            ...
            field={
              isEditable ? (
                <AdEditInput name="p_applicant_persons__1.office_industry_other" convertFullWidth />
              ) : (
        ...
        {formik.values.p_applicant_persons__1.office_occupation_detail === '99' && (
          <EditRow
            ...
            field={
              isEditable ? (
                <AdEditInput name="p_applicant_persons__1.office_occupation_detail_other" convertFullWidth />
              ) : (
        ...
        <EditRow
          ...
          field={
            isEditable ? (
              <AdEditInput name="p_applicant_persons__1.office_name_kana" convertFullWidth />
            ) : (
        ...
        <EditRow
          ...
          field={
            isEditable ? (
              <AdEditInput name="p_applicant_persons__1.office_head_location" convertFullWidth />
            ) : (
        ...
        <EditRow
          ...
          field={
            isEditable ? (
              <AdEditInput name="p_applicant_persons__1.office_prefecture_kana" convertFullWidth />
            ) : (
        ...
        <EditRow
          ...
          field={
            isEditable ? (
              <AdEditInput name="p_applicant_persons__1.office_city_kana" convertFullWidth />
            ) : (
        ...
        <EditRow
          ...
          field={
            isEditable ? (
              <AdEditInput name="p_applicant_persons__1.office_district_kana" convertFullWidth />
            ) : (
        ...
        <EditRow
          ...
          field={
            isEditable ? (
              <AdEditInput name="p_applicant_persons__1.office_other_address_kana" convertFullWidth />
            ) : (
        ...
        {isMCJ && (
          <Stack>
            ...
            <EditRow
              ...
              field={
                isEditable ? (
                  <AdNumericInput name="p_applicant_persons__1.before_last_year_bonus_income" maxLength={6} />
                ) : (
                  formatMoney(formik.values.p_applicant_persons__1.before_last_year_bonus_income)
                )
              }
              error={formik.errors?.p_applicant_persons__1?.before_last_year_bonus_income}
            />
          </Stack>
        )}
        <EditRow
