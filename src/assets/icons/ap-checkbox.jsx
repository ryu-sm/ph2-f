export const ApCheckboxIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <g filter="url(#filter0_i_18497_5721)">
        <path
      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix type="matrix" values="0 0 0 0 0.17099 0 0 0 0 0.209946 0 0 0 0 0.6125 0 0 0 0.1 0" />
          <feBlend mode="normal" in2="shape" result="effect1_innerShadow_18497_5721" />
        </filter>
      </defs>
    </svg>
  );
